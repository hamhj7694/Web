            ...
            logoutBtn.addEventListener('click', function(event) {
                ...
                fetch(getApiPath('logout'))
                    ...
                    .then(function(data) {
                        ...
                        localStorage.removeItem('omechu_user_role');
                        localStorage.removeItem('omechu_is_admin');
        ...
        .then(function(data) {
            if (!data.success) {
                ...
                if (isLogin && loginUser) {
                    ...
                    localStorage.setItem('omechu_user_role', loginUser.role || 'user');
                    localStorage.setItem('omechu_is_admin', loginUser.isAdmin ? 'true' : 'false');
                } else {
                    localStorage.removeItem('omechu_is_login');
                    localStorage.removeItem('omechu_user_no');
                    localStorage.removeItem('omechu_user_id');
